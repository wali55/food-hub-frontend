...
const CancelOrderStatusAlert = ({ status, orderId }: { status: string, orderId: string }) => {
  ...
  return (
    <AlertDialog open={open}>
      <AlertDialogTrigger asChild>
        <Button onClick={() => setOpen(true)} className="bg-red-500" size="xs">CANCEL</Button>
      </AlertDialogTrigger>
      <AlertDialogContent>
        <AlertDialogHeader>
          <AlertDialogTitle>
...
export default CancelOrderStatusAlert;
